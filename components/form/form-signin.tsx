...
import { IFormSignInInput } from "./form.types";
...
export function FormSignIn() {
    ...
    const onSubmit: SubmitHandler<IFormSignInInput> = async (data) => {
        try {
    ...
    return (
        <div className="shadow-input mx-auto w-full max-w-md rounded-2xl bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border">
